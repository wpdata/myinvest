...
if fetch_button or (f'market_data_{symbol}' in st.session_state):
    if fetch_button:
        ...
        if not is_valid:
            ...
            with st.expander("📚 支持的代码类型"):
                ...
                **ETF 基金：**
                - ✅ 上海ETF：50/51xxx.SH（如 510300.SH - 沪深300ETF）
                ...
                **期权：**
                - ✅ 50ETF期权：10xxxxxx.SH（如 10005102.SH）
    ...
    st.markdown("""
    1. **代码格式**：
       - 股票：`600519.SH` (茅台), `000001.SZ` (平安银行)
       - 期货：`IF2506.CFFEX` (沪深300股指期货)
       - 期权：`10005102.SH` (50ETF期权)
